...
function HF_ERPA_main()

    Int_Params = Any[16.0, 3, 6, 9]
    NN_File = "IO/NN.bin"
    NNN_File = "IO/NNN.bin"
    Calc_Params = Any[4, 2, 3, 6, 9, "CMS1+2B", true, "Bin"]
    HF_Solver(Int_Params, NN_File, NNN_File, Calc_Params)

    RPA_Input_Path = "IO/A4_Z2_hw16.0_Nmax3_N2max6_N3max9_CMS1+2B"
    RPA_Calc_Params = Any[4, 2, 16.0, 3, true, [0.0, 50.0, 0.5], [0.0, 50.0, 3.0]]
