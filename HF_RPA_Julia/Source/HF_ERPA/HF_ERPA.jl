function HF_ERPA(Params::Vector{Any},Orb::Vector{NOrb},Orb_NN::NNOrb,VNN::NNInt)
    ...
    @time E_RPA, X_RPA, Y_RPA, pRho, nRho = HF_ERPA_Iteration(Params,N_nu,Orb_Phonon,Phonon,Particle,Hole,Orb,Orb_NN,VNN,TrOp)
    ...
    @time E_0_RPA = HF_ERPA_Energy(Params,N_nu,Orb_Phonon,Phonon,Particle,N_Hole,Hole,Orb,Orb_NN,VNN,X_RPA,Y_RPA,pRho,nRho)

    # ERPA solutions export ...
    @time HF_ERPA_Export(Params,Orb,N_nu,E_0_RPA,E_RPA,s,rB,pRho,nRho)
