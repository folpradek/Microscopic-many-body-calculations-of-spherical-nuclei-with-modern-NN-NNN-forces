function HF_ERPA_Spur_Ini(N_ph::Int64,Orb_Phonon::Vector{Int64},Phonon::Vector{PhState},Particle::pnVec,Hole::pnVec,TrOp::TranOper,pRho::Matrix{Float64},nRho::Matrix{Float64},X_RPA::Matrix{Matrix{ComplexF64}},Y_RPA::Matrix{Matrix{ComplexF64}})
