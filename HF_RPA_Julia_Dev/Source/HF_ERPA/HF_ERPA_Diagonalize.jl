function HF_ERPA_Diagonalize(Params::Vector{Any},pRho::Matrix{Float64},nRho::Matrix{Float64},A::Matrix{Matrix{Float64}},B::Matrix{Matrix{Float64}},N_nu::Matrix{Int64},Orb_Phonon::Matrix{Vector{Int64}},Phonon::Vector{PhState},Particle::pnVec,Hole::pnVec,TrOp::TranOper)
    ...
    @inbounds for JP in JP_List
        ...
        if (Orthogon == true) && (J == 1) && (P == 2)
            Spur_State = HF_ERPA_Spur_Ini(pRho,nRho,N_ph,Orb_Phonon[J+1,P],Phonon,Particle,Hole,TrOp)
