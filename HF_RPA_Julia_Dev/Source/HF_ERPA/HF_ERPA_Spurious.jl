function HF_ERPA_Spur_Ini(pRho::Matrix{Float64},nRho::Matrix{Float64},N_ph::Int64,Orb_Phonon::Vector{Int64},Phonon::Vector{PhState},Particle::pnVec,Hole::pnVec,TrOp::TranOper)
