...
function V2B_Res_Ind1(Params::Vector{Any},Orb::Vector{NOrb},Orb_NN::NNOrb,VNN::NNInt)
    ...
    pU_Import = "IO/" * Output_File * "/pU.bin"
    ...
    nU_Import = "IO/" * Output_File * "/nU.bin"
...
function V2B_Res_Ind1_MEs(a::Int64,b::Int64,c::Int64,d::Int64,i::Int64,J::Int64,pU::Matrix{Float64},nU::Matrix{Float64},VNN::NNInt,Orb::Vector{NOrb},Orb_NN::NNOrb)
...
function V2B_Res_Ind2_MEs(P::Int64,J::Int64,Bra::Int64,Ket::Int64,i::Int64,b::Int64,pU::Matrix{Float64},nU::Matrix{Float64},VNN_Res_I::NNInt_Res)
    return @views pU[i,b] * VNN_Res_I.pp[P,J+1][Bra,Ket], nU[i,b] * VNN_Res_I.pn[P,J+1][Bra,Ket], nU[i,b] * VNN_Res_I.nn[P,J+1][Bra,Ket]
end

function V2B_Res_Ind3_MEs(P::Int64,J::Int64,Bra::Int64,Ket::Int64,i::Int64,c::Int64,pU::Matrix{Float64},nU::Matrix{Float64},VNN_Res_I::NNInt_Res)
    return @views VNN_Res_I.pp[P,J+1][Bra,Ket] * pU[i,c], VNN_Res_I.pn[P,J+1][Bra,Ket] * pU[i,c], VNN_Res_I.nn[P,J+1][Bra,Ket] * nU[i,c]
end

function V2B_Res_Ind4_MEs_t0(P::Int64,J::Int64,Bra::Int64,Ket::Int64,i::Int64,d::Int64,nU::Matrix{Float64},VNN_Res_II::NNInt_Res)
    return @views VNN_Res_II.pn[P,J+1][Bra,Ket] * nU[i,d]
end

function V2B_Res_Ind4_MEs_t1(P::Int64,J::Int64,Bra::Int64,Ket::Int64,i::Int64,d::Int64,pU::Matrix{Float64},nU::Matrix{Float64},VNN_Res_II::NNInt_Res)
    return @views VNN_Res_II.pp[P,J+1][Bra,Ket] * pU[i,d], VNN_Res_II.nn[P,J+1][Bra,Ket] * nU[i,d]
end

function V2B_Res_Export_Old(Params::Vector{Any},Orb_NN::NNOrb,VNN_Res::NNInt)
    # Read parameters ...
    N_max = Params[7]
    N_2max = 2*N_max
    Output_File = Params[13]
    ...
    J_max = N_2max + 1
    V2B_Res_Export = "Output/" * Output_File * "/V2B_Res.bin"

    # Export residual 2-body interaction ...

    println("\nExporting residual 2-body interaction ...")
...
function V2B_Res_Export_Bin(Params::Vector{Any},Orb_NN::NNOrb,VNN_Res::NNInt)
    ...
    J_max = N_2max + 1
    V2B_Res_Export = "IO/" * Output_File * "/V2B_Res.bin"
...
function V2B_Res_Export_HRBin(Params::Vector{Any},Orb_NN::NNOrb,VNN_Res::NNInt)
    ...
    J_max = N_2max + 1
    V2B_Res_Export = "IO/" * Output_File * "/V2B_Res_HR.bin"
...
function V2B_Res_Import(N_max::Int64,Import_File::String,Orb::Vector{NOrb})
    ...
    N_2max = 2*N_max
    J_max = N_2max + 1
    V2B_Res_Import = Import_File * "/V2B_Res.bin"
    ...
    open(V2B_Res_Import, "r") do Read_File
        # ppV
        @inbounds for J in 0:J_max
            @inbounds for P in 1:2
                N_t1 = Orb_NN.N[2,P,J+1]
